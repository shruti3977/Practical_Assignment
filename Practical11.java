...
public class Practical11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Shruti Sangani", 18, 'f');
        Triplet<String, Integer, Character> p2 = Triplet.of("Radha", 20, 'f');
        Triplet<String, Integer, Character> p3 = Triplet.of("Krushn", 19, 'M');
